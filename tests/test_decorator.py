...
@capsula.context(capsula.CommandContext.builder("pip freeze --exclude-editable > requirements.txt"), mode="pre")
@capsula.context(capsula.CommandContext.builder("poetry check --lock"), mode="pre")
...
@capsula.context(capsula.FileContext.builder(Path(__file__).parents[1] / "poetry.lock", copy=True), mode="pre")
